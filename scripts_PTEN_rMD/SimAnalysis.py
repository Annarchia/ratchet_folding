...
dirData = "/home/annarita.zanon/ratchet/PTEN_WT/data"
sysName = "PTEN_WT"         # System name

n_unfolded = 1   # unfolding trajectory
n_ratchet = 10    # Number of refolding traj per unfolding traj
...
for i in range(n_unfolded, n_unfolded +1):
    ...
    native = f"{dirData}/iter_{i}/unfolding/nvt_protein.gro"
