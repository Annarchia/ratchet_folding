...
gmx = "gmx"
mdpDir = "/home/annarita.zanon/ratchet/mdp_files_LYSO"
gen_top = False
water = 'tip3p'
...
# targetConf = "/home/annarita.zanon/ratchet/lysozyme/LYSO/conf/LYSO.pdb"
# wDir = "/home/annarita.zanon/ratchet/lysozyme/LYSO" # Working directory
# topDir = f"/home/annarita.zanon/ratchet/lysozyme/LYSO/data/iter_{i+1}/ratchet_init"

#############
# rMD Y178D #
#############

sysName = "PTEN_Y178D"  # System name
i = 1
n_unfolded = 1 # Number of unfolding trajectories
n_ratchet = 3 # Number of refolding traj per unfolding
boxL = 1  # Simulation box dimension
targetConf = "/home/annarita.zanon/ratchet/PTEN_Y178D/conf/PTEN_Y178D.pdb"
wDir = "/home/annarita.zanon/ratchet/PTEN_Y178D" # Working directory
topDir = f"/home/annarita.zanon/ratchet/PTEN_Y178D/data/iter_{i+1}/ratchet_init"
