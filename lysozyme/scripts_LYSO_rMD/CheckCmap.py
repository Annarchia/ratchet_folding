...
targetConf = f"/home/annarita.zanon/ratchet/lysozyme/LYSO/data/iter_1/unfolding/init_conf.gro"
Cmap = Structure(targetConf).sarr
print(Cmap)
...
# native = fa.Trajectory('/home/annarita.zanon/ratchet/lysozyme/LYSO/conf/LYSO.pdb')
